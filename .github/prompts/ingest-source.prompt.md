---
agent: 'wiki-capture'
description: "Capture a URL or text as a new raw source for later wiki processing"
---
...
5. Report what was captured and suggest running @wiki-ingest to process it
