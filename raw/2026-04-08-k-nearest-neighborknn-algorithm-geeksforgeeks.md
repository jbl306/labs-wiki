...
type: url
captured: 2026-04-08T01:11:51.087870+00:00
source: android-share
url: "https://www.geeksforgeeks.org/machine-learning/k-nearest-neighbours/"
content_hash: "sha256:584f2412da4bb5100ac86fd41363d0c4192cf33d62ac55ba8debcce205eca206"
tags: []
status: ingested
---
...
## Fetched Metadata
- fetched_at: 2026-04-21T13:33:01+00:00
- source_url: https://www.geeksforgeeks.org/machine-learning/k-nearest-neighbours/
- resolved_url: https://www.geeksforgeeks.org/machine-learning/k-nearest-neighbours/
- content_type: text/html; charset=utf-8
- image_urls: ["https://media.geeksforgeeks.org/wp-content/uploads/20251216105443623688/y_axis.webp%22%20alt="]

## Fetched Content
K‑Nearest Neighbor (KNN) is a simple and widely used machine learning technique for classification and regression tasks. It works by identifying the
K
closest data points to a given input and making predictions based on the majority class or average value of those neighbors.
...
Counter
is used to count the occurrences of elements in a list or iterable. In KNN after finding the k nearest neighbor labels Counter helps count how many times each label appears.
Python
````
import
numpy
...
euclidean_distance
is to calculate euclidean distance between points.
Python
````
def
euclidean_distance
...
Output:
A
The algorithm calculates the distances of the test point [4, 5] to all training points selects the 3 closest points as k = 3 and determines their labels. Since the majority of the closest points are labelled
'A'
the test point is classified as
'A'
.
In machine learning we can also use Scikit Learn python library which has in built functions to perform KNN machine learning model and for that you refer to
