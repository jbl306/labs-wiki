...
**Disagreements (excluding merge):** 47 of 150
...
| Copilot Session Checkpoint: Fixing Live Graph Taps | `sources/copilot-session-checkpoint-fixing-live-graph-taps.md` | durable-debugging | retain | `keep` | `compress` | 7 | 3 | 0 | hot |
...
| --- | --- | --- | --- | --- | --- | --- |
| Copilot Session Checkpoint: Auto-ingest fix + arxiv loop | `sources/copilot-session-checkpoint-auto-ingest-fix-arxiv-loop.md` | durable-debugging | 5 | 8 | 3 | hot |
...
| Copilot Session Checkpoint: Dashboard Alt-Line Accuracy Fixes | `sources/copilot-session-checkpoint-dashboard-alt-line-accuracy-fixes.md` | durable-debugging | 11 | 7 | 3 | hot |
| Copilot Session Checkpoint: Free Tier Backfill Runner | `sources/copilot-session-checkpoint-free-tier-backfill-runner.md` | durable-workflow | 14 | 3 | 2 | hot |
| Copilot Session Checkpoint: Graph Tracker and Depth Review | `sources/copilot-session-checkpoint-graph-tracker-and-depth-review.md` | durable-architecture | 14 | 5 | 2 | hot |
...
| Copilot Session Checkpoint: Phase 5 Backfill Script Written | `sources/copilot-session-checkpoint-phase-5-backfill-script-written.md` | project-progress | 14 | 4 | 2 | archive |
