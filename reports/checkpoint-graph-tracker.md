...
| Copilot Session Checkpoint: Dashboard Alt-Line Accuracy Fixes | `sources/copilot-session-checkpoint-dashboard-alt-line-accuracy-fixes.md` | durable-debugging | 13 | 7 | 3 | hot |
| Copilot Session Checkpoint: Fixing Live Graph Taps | `sources/copilot-session-checkpoint-fixing-live-graph-taps.md` | durable-debugging | 11 | 7 | 3 | hot |
| Copilot Session Checkpoint: Free Tier Backfill Runner | `sources/copilot-session-checkpoint-free-tier-backfill-runner.md` | durable-workflow | 12 | 3 | 2 | hot |
| Copilot Session Checkpoint: Graph Tracker and Depth Review | `sources/copilot-session-checkpoint-graph-tracker-and-depth-review.md` | durable-architecture | 12 | 5 | 2 | hot |
...
| Copilot Session Checkpoint: Phase 5 Backfill Script Written | `sources/copilot-session-checkpoint-phase-5-backfill-script-written.md` | project-progress | 12 | 4 | 2 | archive |
...
| 13 | `sources/copilot-session-checkpoint-dashboard-alt-line-accuracy-fixes`, `sources/copilot-session-checkpoint-dashboard-prop-line-debug`, `sources/copilot-session-checkpoint-direct-sportsbook-ingestion`, `sources/copilot-session-checkpoint-direct-sportsbook-sources`, `sources/copilot-session-checkpoint-odds-api-quota-optimization-sgo-investigation`, `sources/copilot-session-checkpoint-sgo-data-extraction-fix-and-quality-audit` |
| 11 | `sources/copilot-session-checkpoint-fixing-live-graph-taps`, `sources/copilot-session-checkpoint-github-ingest-depth-fetcher-trim`, `sources/copilot-session-checkpoint-graph-incident-and-cleanup`, `sources/copilot-session-checkpoint-mobile-node-viewer-and-richer-github-ingestion`, `sources/copilot-session-checkpoint-self-synthesizing-r4-checkpoint-clusters` |
| 12 | `sources/copilot-session-checkpoint-free-tier-backfill-runner`, `sources/copilot-session-checkpoint-graph-tracker-and-depth-review`, `sources/copilot-session-checkpoint-phase-5-backfill-script-written`, `sources/copilot-session-checkpoint-planning-and-progress-tracking-complete`, `sources/copilot-session-checkpoint-second-curation-reports` |
