...
related:
  ...
  - "[[CatBoost]]"
tier: hot
tags: [hyperparameter-tuning, optimization, ml-framework]
---
...
Optuna is an automatic hyperparameter optimization software framework, designed for efficient and scalable tuning of machine learning models. It supports features like trial pruning, warmstarting via trial enqueueing, and flexible search spaces.
...
Used in the NBA ML Engine Sprint 10 for hyperparameter tuning with warmstarting to accelerate convergence and improve model performance.

## Associated Concepts

- **[[Warmstarting Hyperparameter Tuning with Optuna]]** — Core optimization framework

## Related Entities

- **[[NBA ML Engine]]** — co-mentioned in source (Tool)
- **[[Docker]]** — co-mentioned in source (Tool)
- **[[LightGBM]]** — co-mentioned in source (Tool)
- **[[XGBoost]]** — co-mentioned in source (Tool)
- **[[CatBoost]]** — co-mentioned in source (Tool)
- **Ensemble Model** — co-mentioned in source (Model)

## Sources

- [[Copilot Session Checkpoint: Sprint 10 Complete and Deployed]] — where this entity was mentioned
